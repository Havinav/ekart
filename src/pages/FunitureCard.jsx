...
<div class="grid gap-6 text-center md:grid-cols-3 lg:gap-12">
  <div class="mb-12 md:mb-0">
    ...
    <h5 class="mb-4 text-xl font-semibold text-black">Maria Smantha</h5>
  ...
  <div class="mb-12 md:mb-0">
    ...
    <h5 class="mb-4 text-xl font-semibold text-black">Lisa Cudrow</h5>
  ...
  <div class="mb-0">
    ...
    <h5 class="mb-4 text-xl font-semibold text-black">John Smith</h5>
