  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-1">
      <div class="max-w-sm flex flex-c bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <Link to={UrlPath.PRODUCTS+"?data=HP"} className="p-1">
          <img
            class="rounded-t-lg"
      ...
      <div class="max-w-sm flex flex-c bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <Link to={UrlPath.PRODUCTS+"?data=SAMSUNG"} className="p-1">
          <img
            class="rounded-t-lg"
      ...
      <div class="max-w-sm flex flex-c bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <Link to={UrlPath.PRODUCTS+"?data=DELL"} className="p-1">
          <img
            class="rounded-t-lg"
      ...
      <div class="max-w-sm flex flex-c bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <Link to={UrlPath.PRODUCTS+"?data=Acer"} className="p-1">
          <img
            class="rounded-t-lg"
